...
class BounceOAuthSecurityConfigurerPlugin @Autowired constructor(
    private val config: BounceConfig,
    adminGateway: BounceAdminGateway
) : BounceSecurityConfigurerPlugin {
    ...
    val clientRegistrationRepository
        @Bean get() = _clientRegistrationRepository
    @Suppress("unused")
    val authorizedClientService
        @Bean get() = _authorizedClientService
    @Suppress("unused")
    val authorizationRequestRepository
        @Bean get() = _authorizationRequestRepository
    @Suppress("unused")
    val accessTokenResponseClient
        @Bean get() = _accessTokenResponseClient
    ...
    override fun configure(http: HttpSecurity) {
        ...
        http.authorizeRequests()
                ...
                .and()
            .exceptionHandling()
                .accessDeniedHandler { request, _, _ ->
